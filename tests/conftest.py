...
def test_credentials():
    test_username = config.get("login_details", "test_username")
    test_password = config.get("login_details", "test_password")
...
def pytest_configure():
    ...
    file_handler = logging.FileHandler("../tests/Test_Report/test_logs.log")
...
def pytest_runtest_makereport(item,call):
    ...
    if report.when == "call": # only after the test function runs
        ...
        if driver_instance:
            ...
            screenshot_dir = "../tests/Test_Report/Screenshots"
